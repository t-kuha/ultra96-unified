...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net PWM_w_Int_0_Interrupt_Out [get_bd_ports ls_mezz_pwm0] [get_bd_pins PWM_w_Int_0/Interrupt_Out] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net PWM_w_Int_1_Interrupt_Out [get_bd_pins PWM_w_Int_1/Interrupt_Out] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net PWM_w_Int_1_PWM_out [get_bd_ports ls_mezz_pwm1] [get_bd_pins PWM_w_Int_1/LEDs]
  ...
  assign_bd_address -offset 0xA0060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs PWM_w_Int_0/s00_axi/reg0] -force
  assign_bd_address -offset 0xA0070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs PWM_w_Int_1/s00_axi/reg0] -force
