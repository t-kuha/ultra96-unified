...
proc create_root_design { parentCell } {
  ...
  set zu_ps_e [ create_bd_cell -type ip -vlnv xilinx.com:ip:zynq_ultra_ps_e:3.2 zu_ps_e ]
  set_property -dict [ list \
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x80000000 [get_bd_addr_spaces zu_ps_e/Data] [get_bd_addr_segs axi_gpio/S_AXI/Reg] SEG_axi_gpio_0_Reg
