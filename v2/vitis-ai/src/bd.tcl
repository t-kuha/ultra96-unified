...
proc create_root_design { parentCell } {
  ...
  set zynq_us [ create_bd_cell -type ip -vlnv xilinx.com:ip:zynq_ultra_ps_e:3.5 zynq_us ]
  set_property -dict [list \
...
\
  ...
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins ps_rst_2/peripheral_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins zynq_us_axi_periph/ARESETN] [get_bd_pins zynq_us_axi_periph/M00_ARESETN] [get_bd_pins zynq_us_axi_periph/S00_ARESETN]
  ...
  connect_bd_net -net clk_wiz_clk_out2 [get_bd_pins clk_wiz/clk_out2] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins ps_rst_2/slowest_sync_clk] [get_bd_pins zynq_us/maxihpm0_lpd_aclk] [get_bd_pins zynq_us_axi_periph/ACLK] [get_bd_pins zynq_us_axi_periph/M00_ACLK] [get_bd_pins zynq_us_axi_periph/S00_ACLK]
  ...
  set_property PFM.CLOCK {clk_out0 {id "0" is_default "true" proc_sys_reset "/ps_rst_0" status "fixed" freq_hz "300000000"} clk_out1 {id "1" is_default "false" proc_sys_reset "/ps_rst_1" status "fixed" freq_hz "600000000"} clk_out2 {id "2" is_default "false" proc_sys_reset "/ps_rst_2" status "fixed" freq_hz "100000000"}} [get_bd_cells /clk_wiz]
