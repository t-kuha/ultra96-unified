...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {250.00} \
   CONFIG.CLKOUT2_JITTER {97.082} \
   CONFIG.CLKOUT2_PHASE_ERROR {98.575} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {500.00} \
  ...
  connect_bd_net -net zynq_us_pl_resetn0 [get_bd_pins clk_wiz/resetn] [get_bd_pins ps_rst_0/ext_reset_in] [get_bd_pins ps_rst_1/ext_reset_in] [get_bd_pins zynq_us/pl_resetn0]
  ...
  set_property PFM.CLOCK {clk0 {id "0" is_default "true" proc_sys_reset "/ps_rst_0" status "fixed"} clk1 {id "1" is_default "false" proc_sys_reset "/ps_rst_1" status "fixed"}} [get_bd_cells /clk_wiz]
