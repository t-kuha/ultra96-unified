...
################################################################
# This is a generated script based on design: u96v2_tensil
#
...
# source u96v2_tensil_script.tcl
...
\
  ...
  # Create instance: top_ultra96v2_0, and set properties
  set block_name top_ultra96v2
  set block_cell_name top_ultra96v2_0
  if { [catch {set top_ultra96v2_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $top_ultra96v2_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins top_ultra96v2_0/instruction]
  ...
  connect_bd_intf_net -intf_net top_ultra96v2_0_m_axi_dram0 [get_bd_intf_pins top_ultra96v2_0/m_axi_dram0] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP1_FPD]
  connect_bd_intf_net -intf_net top_ultra96v2_0_m_axi_dram1 [get_bd_intf_pins top_ultra96v2_0/m_axi_dram1] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP2_FPD]
  ...
  [get_bd_pins top_ultra96v2_0/reset]
  ...
  [get_bd_pins top_ultra96v2_0/clock]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces top_ultra96v2_0/m_axi_dram0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces top_ultra96v2_0/m_axi_dram0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces top_ultra96v2_0/m_axi_dram1] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces top_ultra96v2_0/m_axi_dram1] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM] -force
