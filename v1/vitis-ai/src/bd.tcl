...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins ps_rst_0/dcm_locked] [get_bd_pins ps_rst_1/dcm_locked]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins concat_0/dout] [get_bd_pins zu_ps/pl_ps_irq0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins zu_ps/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins clk_wiz_0/resetn] [get_bd_pins ps_rst_0/ext_reset_in] [get_bd_pins ps_rst_1/ext_reset_in] [get_bd_pins zu_ps/pl_resetn0]
  ...
  set_property PFM.CLOCK {clk_out1 {id "0" is_default "true" proc_sys_reset "/ps_rst_0" status "fixed"} clk_out2 {id "1" is_default "false" proc_sys_reset "/ps_rst_1" status "fixed"}} [get_bd_cells /clk_wiz_0]
  set_property PFM.IRQ {In0 {} In1 {} In2 {} In3 {} In4 {} In5 {} In6 {} In7 {}} [get_bd_cells /concat_0]
