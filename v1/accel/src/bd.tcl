...
proc create_root_design { parentCell } {
  ...
  set zu_ps [ create_bd_cell -type ip -vlnv xilinx.com:ip:zynq_ultra_ps_e:3.5 zu_ps ]
  set_property -dict [list \
...
\
  ...
  # Create instance: zu_ps_axi_periph, and set properties
  set zu_ps_axi_periph [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 zu_ps_axi_periph ]
  set_property CONFIG.NUM_MI {1} $zu_ps_axi_periph
  ...
  [get_bd_pins zu_ps/maxihpm0_lpd_aclk] \
  [get_bd_pins zu_ps_axi_periph/ACLK] \
  [get_bd_pins zu_ps_axi_periph/M00_ACLK] \
  [get_bd_pins zu_ps_axi_periph/S00_ACLK]
  ...
  [get_bd_pins ps_rst_3/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out5  [get_bd_pins clk_wiz_0/clk_out5] \
  [get_bd_pins ps_rst_4/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_locked  [get_bd_pins clk_wiz_0/locked] \
  [get_bd_pins ps_rst_0/dcm_locked] \
  [get_bd_pins ps_rst_1/dcm_locked] \
  [get_bd_pins ps_rst_2/dcm_locked] \
  [get_bd_pins ps_rst_3/dcm_locked] \
  [get_bd_pins ps_rst_4/dcm_locked]
  connect_bd_net -net emio_uart0_ctsn_0_1  [get_bd_ports BT_HCI_RTS] \
  [get_bd_pins zu_ps/emio_uart0_ctsn]
  connect_bd_net -net ps_rst_0_peripheral_aresetn  [get_bd_pins ps_rst_0/peripheral_aresetn] \
  [get_bd_pins axi_intc_0/s_axi_aresetn] \
  [get_bd_pins zu_ps_axi_periph/ARESETN] \
  [get_bd_pins zu_ps_axi_periph/M00_ARESETN] \
  [get_bd_pins zu_ps_axi_periph/S00_ARESETN]
  connect_bd_net -net xlslice_0_Dout  [get_bd_pins xlslice_0/Dout] \
  [get_bd_ports fan_en_b]
  connect_bd_net -net zu_ps_emio_ttc0_wave_o  [get_bd_pins zu_ps/emio_ttc0_wave_o] \
  [get_bd_pins xlslice_0/Din]
  connect_bd_net -net zu_ps_emio_uart0_rtsn  [get_bd_pins zu_ps/emio_uart0_rtsn] \
  [get_bd_ports BT_HCI_CTS]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0  [get_bd_pins zu_ps/pl_clk0] \
  [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0  [get_bd_pins zu_ps/pl_resetn0] \
  [get_bd_pins clk_wiz_0/resetn] \
  [get_bd_pins ps_rst_0/ext_reset_in] \
  [get_bd_pins ps_rst_1/ext_reset_in] \
  [get_bd_pins ps_rst_2/ext_reset_in] \
  [get_bd_pins ps_rst_3/ext_reset_in] \
  [get_bd_pins ps_rst_4/ext_reset_in]

  # Create address segments
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zu_ps/Data] [get_bd_addr_segs axi_intc_0/S_AXI/Reg] -force
