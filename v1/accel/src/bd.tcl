...
\
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins ps_rst_0/slowest_sync_clk] [get_bd_pins zu_ps/maxihpm0_lpd_aclk] [get_bd_pins zu_ps_axi_periph/ACLK] [get_bd_pins zu_ps_axi_periph/M00_ACLK] [get_bd_pins zu_ps_axi_periph/S00_ACLK]
