...
proc create_root_design { parentCell } {
  ...
  set ls_mezz_pwm_out1 [ create_bd_port -dir O -from 0 -to 0 ls_mezz_pwm_out1 ]
  set ls_mezz_pwm_out2 [ create_bd_port -dir O -from 0 -to 0 ls_mezz_pwm_out2 ]
  ...
  set ls_mezz_uart2_rx [ create_bd_port -dir I ls_mezz_uart2_rx ]
  set ls_mezz_uart2_tx [ create_bd_port -dir O ls_mezz_uart2_tx ]
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins PWM_w_Int_0/s00_axi] [get_bd_intf_pins axi_smc/M01_AXI]
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins PWM_w_Int_1/s00_axi] [get_bd_intf_pins axi_smc/M02_AXI]
  connect_bd_intf_net -intf_net axi_smc_M03_AXI [get_bd_intf_pins axi_smc/M03_AXI] [get_bd_intf_pins axi_uart16550_0/S_AXI]
  connect_bd_intf_net -intf_net axi_smc_M04_AXI [get_bd_intf_pins axi_smc/M04_AXI] [get_bd_intf_pins axi_uart16550_1/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_smc_M07_AXI [get_bd_intf_pins axi_smc/M07_AXI] [get_bd_intf_pins system_management_wiz_0/S_AXI_LITE]
  ...
  connect_bd_net -net PWM_w_Int_0_Interrupt_Out [get_bd_pins PWM_w_Int_0/Interrupt_Out] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net PWM_w_Int_0_PWM_out [get_bd_ports ls_mezz_pwm_out1] [get_bd_pins PWM_w_Int_0/PWM_out]
  connect_bd_net -net PWM_w_Int_1_Interrupt_Out [get_bd_pins PWM_w_Int_1/Interrupt_Out] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net PWM_w_Int_1_PWM_out [get_bd_ports ls_mezz_pwm_out2] [get_bd_pins PWM_w_Int_1/PWM_out]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_ports ls_mezz_rst] [get_bd_pins axi_gpio_0/gpio2_io_o]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports fan_pwm] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net axi_uart16550_0_ip2intc_irpt [get_bd_pins axi_uart16550_0/ip2intc_irpt] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net axi_uart16550_0_sout [get_bd_ports ls_mezz_uart1_tx] [get_bd_pins axi_uart16550_0/sout]
  connect_bd_net -net axi_uart16550_1_ip2intc_irpt [get_bd_pins axi_uart16550_1/ip2intc_irpt] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net axi_uart16550_1_sout [get_bd_ports ls_mezz_uart2_tx] [get_bd_pins axi_uart16550_1/sout]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins PWM_w_Int_0/s00_axi_aresetn] [get_bd_pins PWM_w_Int_1/s00_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_uart16550_0/s_axi_aresetn] [get_bd_pins axi_uart16550_1/s_axi_aresetn] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] [get_bd_pins system_management_wiz_0/s_axi_aresetn]
  connect_bd_net -net sin_0_1 [get_bd_ports ls_mezz_uart1_rx] [get_bd_pins axi_uart16550_0/sin]
  connect_bd_net -net sin_0_2 [get_bd_ports ls_mezz_uart2_rx] [get_bd_pins axi_uart16550_1/sin]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0001000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs PWM_w_Int_0/s00_axi/reg0] SEG_PWM_w_Int_0_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0xA0002000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs PWM_w_Int_1/s00_axi/reg0] SEG_PWM_w_Int_1_reg0
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0003000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0004000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_1/S_AXI/Reg] SEG_axi_gpio_1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_uart16550_0/S_AXI/Reg] SEG_axi_uart16550_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0020000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_uart16550_1/S_AXI/Reg] SEG_axi_uart16550_1_Reg
  create_bd_addr_seg -range 0x00002000 -offset 0xA0006000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs system_management_wiz_0/S_AXI_LITE/Reg] SEG_system_management_wiz_0_Reg
